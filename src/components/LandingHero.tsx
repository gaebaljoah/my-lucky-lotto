...
export const LandingHero = () => {
  ...
  return (
    <div className="text-center mb-6 md:mb-8 relative px-2">
      {/* Decorative floating balls - 모바일에서는 숨김 */}
      ...
      {/* Icon */}
      <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-primary/20 mb-4 md:mb-6 animate-pulse-glow">
